    ...
    switch (arity) {
      ...
      case 3:
        return function(param2, param$1) {
          return o(a0, param2, param$1);
        };
      case 4:
        return function(param2, param$1, param$2) {
          return o(a0, param2, param$1, param$2);
        };
      case 5:
        return function(param2, param$1, param$2, param$3) {
          return o(a0, param2, param$1, param$2, param$3);
        };
      case 6:
        return function(param2, param$1, param$2, param$3, param$4) {
          return o(a0, param2, param$1, param$2, param$3, param$4);
        };
      case 7:
        return function(param2, param$1, param$2, param$3, param$4, param$5) {
          return o(a0, param2, param$1, param$2, param$3, param$4, param$5);
        };
      default:
        return app(o, [a0]);
    }
...
function _2(o, a0, a1) {
  ...
  if (arity === 2) {
    ...
    switch (arity) {
      ...
      case 3:
        return function(param2) {
          return o(a0, a1, param2);
        };
      case 4:
        return function(param2, param$1) {
          return o(a0, a1, param2, param$1);
        };
      case 5:
        return function(param2, param$1, param$2) {
          return o(a0, a1, param2, param$1, param$2);
        };
      case 6:
        return function(param2, param$1, param$2, param$3) {
          return o(a0, a1, param2, param$1, param$2, param$3);
        };
      case 7:
        return function(param2, param$1, param$2, param$3, param$4) {
          return o(a0, a1, param2, param$1, param$2, param$3, param$4);
        };
      default:
        return app(o, [
          a0,
...
function _3(o, a0, a1, a2) {
  ...
  if (arity === 3) {
    ...
    switch (arity) {
      ...
      case 4:
        return function(param2) {
          return o(a0, a1, a2, param2);
        };
      case 5:
        return function(param2, param$1) {
          return o(a0, a1, a2, param2, param$1);
        };
      case 6:
        return function(param2, param$1, param$2) {
          return o(a0, a1, a2, param2, param$1, param$2);
        };
      case 7:
        return function(param2, param$1, param$2, param$3) {
          return o(a0, a1, a2, param2, param$1, param$2, param$3);
        };
      default:
        return app(o, [
          a0,
...
function _4(o, a0, a1, a2, a3) {
  ...
  if (arity === 4) {
    ...
    switch (arity) {
      ...
      case 5:
        return function(param2) {
          return o(a0, a1, a2, a3, param2);
        };
      case 6:
        return function(param2, param$1) {
          return o(a0, a1, a2, a3, param2, param$1);
        };
      case 7:
        return function(param2, param$1, param$2) {
          return o(a0, a1, a2, a3, param2, param$1, param$2);
        };
      default:
        return app(o, [
          a0,
...
function _5(o, a0, a1, a2, a3, a4) {
  ...
  if (arity === 5) {
    ...
    switch (arity) {
      ...
      case 6:
        return function(param2) {
          return o(a0, a1, a2, a3, a4, param2);
        };
      case 7:
        return function(param2, param$1) {
          return o(a0, a1, a2, a3, a4, param2, param$1);
        };
      default:
        return app(o, [
          a0,
...
function _6(o, a0, a1, a2, a3, a4, a5) {
  ...
  if (arity === 6) {
    ...
    switch (arity) {
      ...
      case 7:
        return function(param2) {
          return o(a0, a1, a2, a3, a4, a5, param2);
        };
      default:
        return app(o, [
          a0,
...
var event_nodes_exports = {};
__export(event_nodes_exports, {
  midinoteallocate: () => midinoteallocate,
  midinotein: () => midinotein,
  midinoteshift: () => midinoteshift,
  midinoteunpack: () => midinoteunpack,
  param: () => param
});
function midinotein(...args) {
  return createNode("midinotein", {}, args.map(resolve));
}
function midinoteallocate(props, ...children) {
  return createNode("midinoteallocate", props, children.map(resolve));
}
function midinoteunpack(props, ...children) {
  return unpack(createNode("midinoteunpack", props, children.map(resolve)), 2);
}
function midinoteshift(props, ...children) {
...
var stdlib = __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, core_exports), dynamics_exports), envelopes_exports), event_nodes_exports), filters_exports), math_exports), oscillators_exports), signals_exports), {
  mc: mc_exports,
  const: constant,
  in: identity
});
...
//# sourceMappingURL=chunk-BTN7QJ4V.js.map
